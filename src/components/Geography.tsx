          ...
          <div className="reveal-animation animate-fade-in-up delay-200">
            <div className="relative">
              ...
              <div className="absolute top-[30%] left-[45%] transform -translate-x-1/2 -translate-y-1/2">
                <div className="bg-p2gs-navy text-white text-xs font-medium px-2 py-1 rounded-full shadow-lg">Europe</div>
              </div>
              <div className="absolute top-[42%] left-[51%] transform -translate-x-1/2 -translate-y-1/2">
                <div className="bg-p2gs-blue text-white text-xs font-medium px-2 py-1 rounded-full shadow-lg">Middle East</div>
              </div>
              <div className="absolute top-[56%] left-[47%] transform -translate-x-1/2 -translate-y-1/2">
                <div className="bg-p2gs-lightblue text-white text-xs font-medium px-2 py-1 rounded-full shadow-lg">Africa</div>
              </div>
            </div>
          </div>
